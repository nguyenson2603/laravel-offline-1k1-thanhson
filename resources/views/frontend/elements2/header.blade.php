                    ...
                    <ul class="header-dropdown">
                        ...
                        <li class="onhover-dropdown mobile-account">
                            ...
                            <ul class="onhover-show-div">
                                <li><a href="{{ route('frontend.home.login') }}">Login</a></li>
                                <li><a href="{{ route('frontend.home.register') }}">register</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <div class="main-menu">
                    <div class="menu-left">
                        ...
                        <div class="brand-logo">
                            <a href="{{ route('frontend.home.index') }}"> <img src="{{ asset('frontend-theme/assets/images/icon/logo.png') }}"
                                    ...
                                    <li class="onhover-div mobile-cart">
                                        ...
                                        <ul class="show-div shopping-cart">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img class="me-3"
                                                            src="{{ asset('frontend-theme/assets/images/fashion/product/2.jpg') }}"
                                                            alt="Generic placeholder image"></a>
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h4>item name</h4>
