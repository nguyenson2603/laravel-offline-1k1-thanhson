        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="slide-6-product product-m no-arrow">
                    @if (count($params['big_savings']) > 0)
                        @foreach ($params['big_savings'] as $item)
                            <div class="product-box product-wrap product-style-3">
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="{{ route('frontend.home.products.detail', $item->id) }}"><img alt=""
                                                src="{{ asset('frontend-theme/assets/images/marketplace/pro/52.jpg') }}"
                                ...
                                <div class="product-info">
                                    ...
                                    <h4>{{ number_format($item['price'] * ((100 - $item['sale']) / 100)) . ' VNĐ' }}</h4>
                                    <div class="add-btn">
